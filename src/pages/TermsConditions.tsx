    ...
    <div className="relative min-h-screen py-12 px-6">
      ...
      <section className="max-w-4xl mx-auto text-center mb-16 flex flex-col items-center gap-6 relative z-10">
        <span className="px-3.5 py-1 rounded-full text-xs font-semibold uppercase tracking-widest bg-gradient-to-r from-secondary/15 to-accent/15 border border-secondary/20 text-secondary flex items-center gap-1.5">
          <Scale className="w-3.5 h-3.5" /> LEGAL AGREEMENTS
        </span>
        ...
        >
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold font-sans text-foreground flex items-center gap-2">
              <CheckCircle className="w-5 h-5 text-secondary" /> 1. Acceptable Use
            </h2>
            <p>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold font-sans text-foreground flex items-center gap-2">
              <Award className="w-5 h-5 text-secondary" /> 2. Client & Candidate Relationships
            </h2>
            <p>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold font-sans text-foreground flex items-center gap-2">
              <FileText className="w-5 h-5 text-secondary" /> 3. Intellectual Property Rights
            </h2>
            <p>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold font-sans text-foreground flex items-center gap-2">
              <Scale className="w-5 h-5 text-secondary" /> 4. Limitation of Liability
            </h2>
            <p>
          ...
          <div className="space-y-4 border-t border-white/5 pt-8">
            <h2 className="text-xl font-bold font-sans text-foreground flex items-center gap-2">
              <HelpCircle className="w-5 h-5 text-secondary" /> 5. Questions & Legal Inquiries
            </h2>
            <p>
              For legal clarification regarding these terms, candidate contracts, or corporate dispute resolutions, please write to:
            </p>
            <div className="flex items-center gap-3 mt-4 bg-white/5 p-4 rounded-xl border border-white/10 w-max">
              <Mail className="w-5 h-5 text-secondary" />
              <div>
                <p className="text-[10px] text-foreground/40 uppercase tracking-widest font-semibold">Corporate Compliance</p>
                <a href="mailto:legal@nexamentes.com" className="text-sm font-semibold text-foreground hover:text-secondary transition-colors">
