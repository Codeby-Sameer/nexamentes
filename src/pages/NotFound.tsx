...
export function NotFound() {
  return (
    <div className="relative min-h-[80vh] flex items-center justify-center px-6">
      ...
      <div className="max-w-md w-full glass-premium p-10 rounded-3xl border border-white/10 shadow-2xl relative text-center flex flex-col items-center gap-6 overflow-hidden">
        {/* Glow */}
        <div className="absolute top-0 left-0 w-32 h-32 bg-secondary/15 rounded-full blur-2xl pointer-events-none" />
        ...
        <div>
          <h1 className="text-7xl font-extrabold tracking-tighter text-secondary font-sans">404</h1>
          <h2 className="text-xl font-bold font-sans text-foreground mt-2">Page Not Discovered</h2>
          <p className="text-xs text-foreground/60 leading-relaxed mt-2.5">
